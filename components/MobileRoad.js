...
// import data from "../utils/mobileData";
...
const MobileRoad = () => {
	return (
		<div>
			<h2 className="text-3xl text-bold text-primary">Roadmap</h2>
			<div className="w-[100%] mt-20 h-[500px]">
				<Chrono items={data} mode="HORIZONTAL" className="lg:hidden" />
				{/* <div className="p-4 ">
					...
					<div className="h-content">
						<ul>
							<li>
								- CQ Network licensing and corporate office in
								U.A.E
							</li>
							<li>
								- CQ pay desktop wallet -Launch(beta version)
							</li>
							<li>
					...
					<div className="w-content">
						<ul>
							...
							<li>
								- CQ network own merchant outlets launch in the
								United Arab emirates
							</li>
							<li>- CQ network online shopping website launch</li>
					...
					<div className="w-content">
						<ul>
							...
							<li>
								- CQD - application beta -iOS/Android/desktop
								launch
							</li>
							<li>- CQD final version launch</li>
							<li>- CQD native token launch</li>
							<li>
								- CQD zero interest loan for CQNC stakeholders
							</li>
						</ul>
					</div>
					<div className="w-content">
						<ul>
							<li>
								- CQD HI integrated trading bots upgradation.
							</li>
							<li>- CQ network blockchain development</li>
							<li>- CQ network blockchain,crypto institutions</li>
							<li>
								- Charity support based on community nation wide
							</li>
						</ul>
					</div>
					<div className="w-content">
						<ul>
							...
							<li>
								- CQB startup fund allocation for entrepreneurs
							</li>
