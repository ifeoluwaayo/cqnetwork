...
const RoadmapSection = () => {
	return (
		<>
			{/* Desktop */}
			<section className="container py-10 mx-auto hidden lg:flex flex-col items-center gap-4 justify-center">
				<h2 className="text-3xl text-bold text-primary">Roadmap</h2>
				<div className="lg:w-[85%] xl:w-[70%]">
			...
			{/* Mobile */}
			<section className="flex lg:hidden">{/* <MobileRoad /> */}</section>
		</>
	);
};
