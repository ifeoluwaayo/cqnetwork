...
import CQBD from "../../assets/coins (1).webp";
			...
			<div className="flex flex-col container rounded-2xl bg-white p-8 shadow-xl gap-6">
				<div className="flex items-center flex-col justify-center ">
					...
					<p className="text-center p-4 text-[14px] text-gray">
						...
						<p className="text-green cursor-pointer flex justify-end items-center">
							... More{" "}
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-6">
					<div
						className="flex flex-col items-center justify-center shadow-xl p-4 rounded-2xl 
